...
class QuestionIndexDetailTests(TestCase):
    ...
    def test_detail_view_with_a_past_question(self):
        """
        The detail view of a question with a pub_date in the past should display
        the question's text.
        """
...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_a_future_question(self):
        """
        Questions with a pub_date in the future should not be displayed on the index
        page.
        """
    ...
    def test_index_view_with_future_question_and_past_question(self):
        """
        If there are both past and future questions, only the past questions should
    ...
    def test_index_view_with_two_past_questions(self):
        """
        The questions index page may display multiple questions from
        the past
        """
...
class QuestionMethodTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recently() should return True if the question is
        within a day old
        """
